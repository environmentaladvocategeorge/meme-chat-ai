const es = {
  ...
  personasCreator: {
    ...
    step: {
      ...
      identity: { title: "¿Quién es tu bot?", hint: "Dale un nombre y una frase." },
    ...
    field: {
      ...
      wordBankHint: "Opcional. Jerga, muletillas y palabras favoritas. Escribe una y pulsa Enter.",
      ...
      tagline: "Frase corta",
      taglineHint: "La versión de dos segundos del rollo.",
      taglinePlaceholder: "ej. grita ánimos, nunca se salta pierna",
      identity: "¿Quién es?",
      identityHint: "Unas frases sobre su rollo. Cómo actúa, qué le gusta.",
      ...
      toneHint: "Opcional. Unas palabras para la energía general.",
      ...
      slang: "Jerga que usa",
      slangHint: "Opcional. Palabras que dice y qué significan.",
      slangPlaceholder: "ej. cooked = acabado, locked in = concentrado",
      gifs: "GIFs de reacción favoritos",
      gifsHint: "Opcional. Búsquedas que usa cuando pega un GIF.",
      gifsPlaceholder: "escribe uno y pulsa intro",
      gifLean: "Cuándo manda GIFs",
      gifLeanHint: "Opcional. Qué tan seguido reacciona.",
